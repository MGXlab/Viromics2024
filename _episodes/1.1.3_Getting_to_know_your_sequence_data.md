...
> - Find a fastq file in the folder with sequencing data on Draco.
>     - How many lines does this file have?
>     - How many sequences are present in the file?
> - Print the first 10 lines and the last 10 lines in the terminal.
>     - What differences do you observe between these lines?
> {: .source}
{: .challenge}
