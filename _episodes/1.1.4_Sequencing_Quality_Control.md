...
> - Use fastq files and summary.txt located where you find sequencing data to generate diff types of quality plots (see the NanoPlot github)
...
> ## Exercise
>
> 4. How does the sequencing quality of the 3 samples compare to each other? Specify your answer with metrics from the NanoPlot results.
>
> 5. Do we need to remove any reads? Why (not)? 
>
> 6. What does Q12 mean? How much data will be lost from each sample if we filter at Q12?
> 
> {: .source}
{: .challenge}
...
> 
> We will use [Chopper](https://github.com/wdecoster/chopper) to filter our reads based on quality scores and length. Build an sbatch script for chopper based on the following basic usage example. Use a for-loop that processes all your reads files. Use the following filtering criteria:
...
> 8. What is the average quality? Is this before or after filtering?
...
> 10. What is the GC content profile of your sequencing reads?  
>     a) Plot the distribution of GC % in each read as a density plot.  
...
> 11. Are these histograms what you expected?  
> 12. How would the GC content of a metagenome differ from these viromes?  
> 13. Describe the difference in GC content between our viromes and [E. coli phage T4](https://trace.ncbi.nlm.nih.gov/Traces/?view=run_browser&acc=SRR29341083&display=metadata) `./data/sequences/T4_SRR29341083.fastq`).  
> 14. What interpretations can you make about the samples based on these plots?  
>{: .source}
{: .challenge}
