...
After you did the [cross-assembly](https://mgxlab.github.io/Viromics2024/1.2.2_assembly_and_cross-assembly/index.html), you used the tool [CheckV](https://bitbucket.org/berkeleylab/checkv/src/master/) to predict completeness and contamination of contigs. Today, you will use its output to filter contigs. As a rule of thumb, you could keep all contigs with completeness >50% and contamination <5%. These values could be changed depending on the data and on the project. For metagenomics and viromics, these values are typically used. If you are an experienced programmer, write (a) script(s) for the filtering. If you are not, use the solutions below.  
