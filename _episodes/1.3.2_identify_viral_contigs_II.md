...
> conserved regions.
>
> To read the tabular files, you can use python's pandas package. First, install it in the virtual
> environment as you installed biopython [yesterday](https://github.com/MGXlab/Viromics2024/blob/gh-pages/_episodes/1.2.2_assembly_and_cross-assembly.md).
>
...
>
> # modify the code from yesterday (rename phage contigs) to go through the assembly and save contigs in the joint selection
>```
> {: .source}
{: .challenge}
