...
> python ./python_scripts/host_prediction/20_translate_taxonomy.py $rafahtable $translation ./2.1_host_prediction/10_rafah/rafah_1_Host_Predictions_gtdb.csv
>
> deactivate
>```
> {: .source}
...
>
># write out to a csv
>df_blast_gtdb_rafah_merged.to_csv('merged_rafah_blastn.csv',index=False)
> ```
> {: .source}
{: .challenge}
...
> #SBATCH --output=./2.1_host_prediction/20_blastn/combine.slurm.%j.out
> #SBATCH --error=./2.1_host_prediction/20_blastn/combine.slurm.%j.err
>
