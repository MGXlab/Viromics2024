...
> 
> ~~~bash
> $ cp /work/groups/VEO/shared_data/Viromics2024Workspace/2.1_host_prediction/ncbi_to_gtdb.csv .
> ~~~
> 
...
> makeblastdb -in file.fasta -out file.fasta -dbtype nucl
>
> # run blastn with the file.fasta database
> blastn -db file.fasta -query filtered_cross_assembly.fasta -out viral_contigs_vs_bins_blastn.out -num_threads 32 -outfmt 6
>
>```
