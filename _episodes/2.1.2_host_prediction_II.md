...
> the NCBI taxonomy into the GTDB taxonomy. There are hundreds of thousands of taxa in both
> schemes, so we need to efficiently map one onto the other. Here are some hints:
> 
> ~~~
> import os, sys
> import pandas as pd
