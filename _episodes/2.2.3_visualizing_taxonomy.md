...
> - Use the taxonomic information encoded in the network to color the nodes accordingly.
> - Use draw_networkx_nodes and draw_networkx_edges for better access to the attributes of the plot.
{: .challenge}
