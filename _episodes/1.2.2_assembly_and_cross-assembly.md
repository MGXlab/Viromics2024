...
exercises: 30
questions:
- "What are the differences between a cross-assembly and merged single assemblies?"
- "Can you find these differences in the two assemblies performed today?"
objectives:
...
- Samples can be assembled indivudially and combined in a cross-assembly
---
...
$vclust prefilter -i 10_results_assembly_flye/single_assemblies/merged_single_assemblies.fasta ...
$vclust align ...
$vclust cluster ...
~~~
{: .language-bash}
