...
> 
> To use this Python package on Draco, install it in the [virtual environment](https://mgxlab.github.io/Viromics2024/virtualenv/index.html)
> you set up yesterday. You can now write a python script that reads your contigs, changes
