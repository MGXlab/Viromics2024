...
> - Which are the longest and shortest lengths?
> - Whats the range of coverage values?
> - How many circular contigs were assembled?
> - How does your guess about the size of the metagenome compare to the actual size?
{: .challenge}

### Separate assemblies

This part is recommended but optional. If you cannot finish it in the suggested time, move on to
the next part of the exercises. The most important part is that you have at least one successful
assembly to continue with today and in the next days.
