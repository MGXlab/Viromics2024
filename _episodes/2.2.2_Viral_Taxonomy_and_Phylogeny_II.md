...
>
>conda activate mamba_20231101_python_3.9
>
>echo `date`
>
>vcontact3 run --nucleotide /work/groups/VEO/shared_data/Viromics2024Workspace/1.2_virome_assembly/10_results_assembly_flye/cross_assembly/assembly.fasta --output 02_vcontact3_results_new_contig_names --db-path /work/groups/VEO/databases/vcontact3/v20231101/ -e cytoscape
>
>echo `date`
>```
>{: .source}
