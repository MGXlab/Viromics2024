...
# A circular map of the genome

{% include base_path.html %}
<p align="center">
    <a href="{{ site.carpentries_site }}"><img src="{{ relative_root_path }}/assets/img/contig_109_circos.png" alt="Compare ORF Predictions" width="1000" /></a>
</p>
...
first and then write a script for plotting the two sets of ORFs. If you run the script(s)
on Draco, please remember to submit it through slurm. The plotting script should not 
need much memory and run on a single core.
